...
class YunTongXun {
	...
	function __construct()
	{
		...
		$this->ServerIP = env('YTX_SERVER_IP', 'sandboxapp.cloopen.com');
		$this->ServerPort = env('YTX_SERVER_PORT', '8883');
		$this->SoftVersion = env('YTX_SOFT_VERSION', '2013-12-26');
        $this->AccountSid = env('YTX_ACCOUNT_SID', 'aaf98f894da43364014da471d5450021');
        $this->AccountToken = env('YTX_ACCOUNT_TOKEN', 'f12b9462f3b14a4da9b2f9edfe611ec5');
        $this->AppId = env('YTX_APPID', '8a48b5514da42dc3014da4720c940045');
